...
const localeInfo = {
  'en-US': {
    messages: require('/Users/iss/项目/闪送配送系统/ss-ds/src/locales/en-US.js').default,
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: require('/Users/iss/项目/闪送配送系统/ss-ds/src/locales/pt-BR.js').default,
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: require('/Users/iss/项目/闪送配送系统/ss-ds/src/locales/zh-CN.js').default,
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: require('/Users/iss/项目/闪送配送系统/ss-ds/src/locales/zh-TW.js').default,
    locale: 'zh-TW',
